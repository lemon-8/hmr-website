		...
		<Box>
			...
			>
				<body>
					...
					<p>Welcome to hmrhostels.com!</p>

					<p>
						These terms and conditions outline the rules and
						regulations for the use of HMR Hostels's Website,
						located at https://hmrhostels.com.
					</p>

					<p>
						By accessing this website we assume you accept these
						terms and conditions. Do not continue to use
						hmrhostels.com if you do not agree to take all of the
					...
					<p>
						...
						hmrhostels.com, you agreed to use cookies in agreement
						with the HMR Hostels's Privacy Policy.{" "}
					</p>
					...
					<p>
						Unless otherwise stated, HMR Hostels and/or its
						licensors own the intellectual property rights for all
						material on hmrhostels.com. All intellectual property
						rights are reserved. You may access this from
						hmrhostels.com for your own personal use subjected to
						restrictions set in these terms and conditions.
					</p>

					<p>You must not:</p>
					<ul>
						<li>Republish material from hmrhostels.com</li>
						<li>
						...
						<li>Redistribute content from hmrhostels.com</li>
					</ul>
					...
					<p>
						HMR Hostels reserves the right to monitor all Comments
					...
					<p>
						You hereby grant HMR Hostels a non-exclusive license to
					...
					<p>
						...
						HMR Hostels; and (d) the link is in the context of
					...
					<p>
						...
						you must inform us by sending an e-mail to HMR Hostels.
					...
					<p>
						No use of HMR Hostels's logo or other artwork will be
